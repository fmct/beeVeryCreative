    ...
    def __init__(self, findAll=False):
        ...
        while (not self.connected) and (not self.exit):
            ...
            if t > nextPullTime:
                ...
                #print str(self.beeConn.getPrinterList()[0]["Interfaces"][0]["EP In"].device.address)
                ...
                if self.beeConn.isConnected() is True:
                    ...
                    print str(self.beeCmd.getTemperatures())
        ...
        self.beeCmd.cancelCalibration()
        #self.beeCmd.move(0,0,-2)
        print str(self.beeCmd.getTemperatures())
